...
from . import agenda_view, build_index, correct, discover, enrich, poll_captions, segment, task_map, threads
...
def main() -> int:
    ...
    # 03 교정 → 04~06 3층 구조 → 07 스레드 → 11 과제 매핑 → 08 색인 → 12 의제 뷰 (§8: 단계별 격리)
    for name, step in (
